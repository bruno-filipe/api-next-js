...
export default function Update(){
    ...
    useEffect(() => {
      fetch('/api/mercados/0', { headers: {'id':'1', 'tk':'7cea26600c288a7055229a1d7e9ba49b'}, method: 'GET'})
        .then((res) => res.json())
        .then((data2) => {
          setData2(data2);
        });
  ...
  function atualizar(e){
    ...
    fetch('/api/precos/'+idP, { headers: {'Content-Type': 'application/json', 'id':'1', 'tk':'7cea26600c288a7055229a1d7e9ba49b'}, method: 'PUT', body: formJson })
    .then((response) => {
      if(response.ok){
